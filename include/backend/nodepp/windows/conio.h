...
#ifndef NODEPP_WINDOWS_CONIO
#define NODEPP_WINDOWS_CONIO
...
namespace nodepp { namespace conio { WORD attr = 0, dflt = 7;
    ...
    inline int perr( const string_t& args ){ DWORD len=0;
    ...
    inline int inverse(){ attr |= COMMON_LVB_REVERSE_VIDEO; return 1; }
    inline int underscore(){ attr |= COMMON_LVB_UNDERSCORE; return 1; }
